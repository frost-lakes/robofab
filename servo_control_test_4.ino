...
void UserCode(void)
{
	...
	I2C_SERVOSPEED(1);		// Line # 1
	ServoSetAll(1889,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500);		// Line # 2
	delay(300);		//Default Delay
	I2C_SERVOSPEED(50);		// Line # 3
	ServoSetAll(2380,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500);		// Line # 4
	delay(300);		//Default Delay
	I2C_SERVOSPEED(1);		// Line # 5
	ServoSetAll(2500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500);		// Line # 6
	delay(300);		//Default Delay
	delay(1000);		// Line # 7
	ServoSetAll(1500,1500,1500,1500,0,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500);		// Line # 8
	delay(300);		//Default Delay
	delay(1000);
